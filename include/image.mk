...
#IMG_PREFIX:=$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)$(BOARD)-$(SUBTARGET)-$(BUILD_DATE_PREFIX)-zuoxm
#IMG_ROOTFS:=$(IMG_PREFIX)-rootfs
#IMG_COMBINED:=$(IMG_PREFIX)-combined
IMG_PREFIX:=$(VERSION_DIST_SANITIZED)-$(BOARD)-$(SUBTARGET)-$(BUILD_DATE_PREFIX)-zuoxm
IMG_ROOTFS:=$(IMG_PREFIX)-rootfs
IMG_COMBINED:=$(IMG_PREFIX)-efi
ifeq ($(DUMP),)
